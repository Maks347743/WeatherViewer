...
public class WeatherFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (url != null) {
          /*  dismissKeyboard();*/
            WeatherFragment.GetWeatherTask getLocalWeatherTask = new WeatherFragment.GetWeatherTask();
            getLocalWeatherTask.execute(url);
        } else {
            Snackbar.make(mView.findViewById(R.id.rootFragmentListWeather), R.string.invalid_url, Snackbar.LENGTH_LONG).show();
        }
        return mView;
    }
